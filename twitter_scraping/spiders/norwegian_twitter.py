...
class NorwegianTwitterSpider(scrapy.Spider):
    name = 'norwegian_twitter'
    ...
    def __init__(self, *args, **kwargs):
        super(NorwegianTwitterSpider, self).__init__(site_name=self.allowed_domains[0], *args, **kwargs)
        self.current_page = 0
